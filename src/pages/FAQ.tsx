...
const faqItems = [
  ...
  { q: "Comment éviter les oublis de devis ?", a: "Avec Bulbiz, chaque demande est structurée et suivie. Vous êtes relancé automatiquement, et rien ne passe entre les mailles du filet." },
