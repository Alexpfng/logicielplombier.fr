...
const Index = () => {
  return (
    <>
      <Seo
        title="Logiciel Plombier — Centralisez vos demandes clients | Bulbiz"
        description="Découvrez le meilleur logiciel pour plombiers et chauffagistes. Bulbiz centralise automatiquement vos demandes clients. Simple, mobile, efficace. Testez gratuitement."
        path="/"
        jsonLd={faqJsonLd(homeFaqItems)}
      />
        ...
        <div className="mt-10 mx-auto max-w-sm">
          <div className="rounded-2xl border border-border bg-card p-3 shadow-lg">
            <video
              ...
              preload="none"
            >
              <source src="/videos/demo-bulbiz.mov" type="video/quicktime" />
